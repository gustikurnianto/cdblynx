...
$('#tulangseting').click(function(){
    $('#ktkinputmenu').hide();
    $('#ktktulang').addClass('animatedz').show();
});
...
$('#orderreservasitools').click(function(){
    $('#loadingorder').show(function(){
        ...
        $('#jumlahKLDsch').text('0');
        $('#jumlahKLDsch').show();
        $('#jumlahKLDsch').css('background', 'white');
        $('#jumlahKLDsch').css('color', 'black');
        $('#jumlahKLDsch').css('border', '0.7px solid transparent');
        $('#kotakInfo').each(function(){
            $(this).find('.judulreservasi').each(function(i) {
                i++;
                $('#jumlahKLDsch').text(i);
            });
        });
...
$('#donetools').click(function(){
    ...
    $('#loadingorder').show(function(){
        ...
        $('#analitiktoolsblack').hide();
        $('#jumlahKLDsch').text('0');
        $('#jumlahKLDsch').css('background', 'black');
        $('#jumlahKLDsch').css('color', 'white');
        $('#jumlahKLDsch').css('border', '0.7px solid white');
        $('#kotakInfoDone').each(function(){
            $(this).find('.judulreservasiDone').each(function(i) {
                i++;
                $('#jumlahKLDsch').text(i);
            });
        });
...
$('#analitiktools').click(function(){
    ...
    $('#loadingorder').show(function(){
        ...
        let dataReservasi = [0, 0, 0, 0, 0, 0, 0, 0, 0];
        ...
        var delapan = $('.titlebuttontulang').text();
        var sembilan = $('.titlebuttonlainnya').text();
                
        const ctx1 = canvas1.getContext("2d");
        const myChart1 = new Chart(ctx1, {
            type: 'bar',
            data: {
                labels: [satu, dua, tiga, empat, lima, enam, tujuh, delapan, sembilan],
                datasets: [{
                    label: 'jumlah reservasi',
                    data: dataReservasi,
                    backgroundColor: ['rgba(30, 163, 245)', 'green', 'red', 'purple', 'blue', 'orange', 'grey', 'darkblue', 'magenta'], 
                    borderRadius: 5
                }]
            },
            options: {
...
document.querySelector('.reservasi').addEventListener('click', function() {
    ...
    document.querySelector('#pagetulang').style.display = 'none';
...
$("#tulangbutton").on("click",function(){
$("#tabel1z").hide();
$(".kotakcancel").hide();
$(".cancelmenuss").show();
$(".reservasi").show();
$(".tambahanreservasi").show();
$(".judulmenu").addClass('animatedzz').show();
$("#pagetulang").addClass('animatedzz').show();
$(".klmpbutton").hide();
var z = document.querySelector(".titlebuttontulang").innerHTML; 
document.querySelector(".cancelmenuss").innerHTML = z; 
document.getElementById("judulreservasi").value = z;
document.getElementById("canceljudul").innerHTML = z;
});
...
$("#time-senindokter").text('pilih dokter');
$("#time-selasadokter").text('pilih dokter');
$("#time-rabudokter").text('pilih dokter');
$("#time-kamisdokter").text('pilih dokter');
$("#time-jumatdokter").text('pilih dokter');
$("#time-sabtudokter").text('pilih dokter');
$("#time-minggudokter").text('pilih dokter');
});
...
$("#colorPickerzz").on("input", function() {
    ...
    $(".tulangbg").css('background-color', z );
...
$("#checkboxfont1").on("click", function() {
    ...
    $(".titlebuttontulang").css('font-family','Poppins');
...
$("#checkboxfont2").on("click", function() {
    ...
    $(".titlebuttontulang").css('font-family','Noto Sans');
...
$("#checkboxfont3").on("click", function() {
    ...
    $(".titlebuttontulang").css('font-family','Open Sans');
...
$("#checkboxfont4").on("click", function() {
    ...
    $(".titlebuttontulang").css('font-family','Source Serif Pro');
...
$("#checkboxmetode1").on("click", function() {
    ...
    $("#tulangbutton").css('border-radius','10px');
...
$("#checkboxmetode2").on("click", function() {
    ...
    $("#tulangbutton").css('border-radius','100px');
...
$("#checkboxmetode1s").on("click", function() {
    ...
    $('.tulangbg').css('width', '48px');
    $('.tulangbg').css('height', '48px');
    $('.tulangbg').css('max-height', '48px');
    $('.tulangbg').css('max-width', '48px');
    ...
    $('.titlebuttontulang').css('margin-left', '0px');
    $('.titlebuttontulang').css('margin-right', '0px');
    $('.titlebuttontulang').css('margin-top', '0px');
    $('.titlebuttontulang').css('margin-bottom', '0px');
    ...
    document.getElementById('tulangbutton').className = "tulangbutton1";
    ...
    document.getElementById('gambarbutton9').value = "tulangbutton1";
...
$("#checkboxmetode1slist").on("click", function() {  
    ...
    $('.titlebuttontulang').css('margin-left', "auto");
    $('.titlebuttontulang').css('margin-right', "13px");
    $('.titlebuttontulang').css('margin-top', "13px");
    $('.titlebuttontulang').css('margin-bottom', "auto");
    ...
    $('.tulangbg').css('width', '40px');
    $('.tulangbg').css('height', '40px');
    $('.tulangbg').css('max-height', '40px');
    $('.tulangbg').css('max-width', '40px');
    ...
    document.getElementById('tulangbutton').className = "tulangbutton1list";
    ...
    document.getElementById('gambarbutton9').value = "tulangbutton1list";
...
$("#checkboxmetode10ssx").change(function() {

    if(this.checked) {
        document.getElementById('hide10result').value = "hide";
        document.getElementById('buttonz10').style.display = "none";
    } else {
        document.getElementById('hide10result').value = "";
        document.getElementById('buttonz10').style.display = "";
    }
